...
public class StudyDocumentDAO implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7182179921060847181L;
...
/////////////0524김대섭/////////////0524김대섭
		...
		if (docList == null)
		{
			...
			docList.add(new StudyDocumentInfo(code, "새 문서", new Date(), directoryName, new StudyContentsInfo(new StringBuilder(newDocCon), new StringBuilder("")), ".java"));
...
/////////////0524김대섭/////////////0524김대섭/////////////0524김대섭/////////////0524김대섭
			...
			try
			{
				while(true)
				{
					...
					if( obj instanceof StudyDocumentInfo )
					{
						...
						StudyDocumentInfo d = (StudyDocumentInfo)obj;
						long serialVersionID = ObjectStreamClass.lookup(d.getClass()).getSerialVersionUID();
