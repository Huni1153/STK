...
////////////////////////////////////////////////////////////////////////
	...
	private boolean scheduleDataFileLoad(){
		ScheduleDataIOController scheduleDataIOController = new ScheduleDataIOController();
		return scheduleDataIOController.requestScheduleFileLoad();
	}
	private boolean scheduleDataFileSave(){
		ScheduleDataIOController scheduleDataIOController = new ScheduleDataIOController();
		return scheduleDataIOController.requestScheduleFileSave();	
	}
...
/////////////////////재영/////////////////////재영
	...
	class DailyScheduleInfoActionListener implements ActionListener{
      public void actionPerformed(ActionEvent e){
		 ...
		 */
		 int check = deleteController.deleteScheduleInfoToDB(dailySchedule.getCodeOfModify());
		 if(check == 1)
            System.out.println("삭제 완료!!!!!!!!!!!");
         else
            System.out.println("삭제 실패!!!!!!!!!!!");
