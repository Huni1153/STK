...
public class DocumentSaveAsUI extends JDialog
{
	...
	public DocumentSaveAsUI(String documentCode,String documentDirectory,StringBuilder left,StringBuilder right, ArrayList<String> leftList, ArrayList<String> rightList)
	{
		this.setTitle("저장하기");
		this.setModal(true);
	...
	class DocumentSaveAsUIListener implements ActionListener
	{
		...
		public void reMake()
		{
			...
			{
				if(this.saveAsController.createJava(tFileName.getText(),leftList,rightList,".java"))
				{
