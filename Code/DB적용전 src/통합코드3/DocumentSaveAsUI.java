...
public class DocumentSaveAsUI extends JDialog
{
	...
	public DocumentSaveAsUI(String documentDirectory,StringBuilder left,StringBuilder right)
	{
		this.setTitle("저장하기");
		this.setModal(true);
	...
	class DocumentSaveAsUIListener implements ActionListener
	{
		...
		public void reMake()
		{
			...
			String documentDate="15/"+month+"/"+month+"/"+day;
			...
			if(((String)cFileType.getSelectedItem()).equals("Java(*.java)"))
			{
				if(this.saveAsController.createJava(tFileName.getText(),leftArea,rightArea,".java"))
				{
					...
					if(this.saveAsController.saveAsStudyDocumentInfo(documentDirectory,tFileName.getText(),documentDate,leftArea,rightArea,".java"))
					{
