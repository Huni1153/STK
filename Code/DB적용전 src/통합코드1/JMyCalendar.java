...
public class JMyCalendar extends JDialog 
{
	...
	public JMyCalendar(AddScheduleInfoUI addScheduleInfoUI){
		this.addScheduleInfoUI = addScheduleInfoUI;
		setModal(true);
		calendarTime = new CalendarTime(addScheduleInfoUI, this);
	...
	/*class JMyCalendarSelectActionListener implements TableColumnModelListener
	{
		public JMyCalendarSelectActionListener(){
		}
	    ...
	    public void columnSelectionChanged(ListSelectionEvent e) {
			...
			if(row > -1 && col > -1 && month != null){
				...
				//System.out.println(year+" "+ month +" "+ tableCalendar.getValueAt(row,col));//확인
