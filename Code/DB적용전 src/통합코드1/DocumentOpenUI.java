...
public class DocumentOpenUI extends JDialog
{
	...
	public DocumentOpenUI(String fileName)
	{
		...
		String [] str={"a","b","c","d"};
		this.sLocationBox=new JComboBox(str);
	...
	public void set()
	{
		...
		c.gridx=0;
		c.gridy=0;
		this.scrollPane2=new JScrollPane(table);
		this.scrollPane2.setPreferredSize(new Dimension(600,300));
		this.centerPanel.add(this.scrollPane2,c);
		...
		c.gridwidth=2;
		//c.weightx=0.1;
		this.bottumPanel.add(this.bSave,c);
		...
		this.bSave.addActionListener(new DocumentOpenUIListener());
		this.bCancel.addActionListener(new DocumentOpenUIListener());
	...
	class DocumentOpenUIListener implements ActionListener
	{
	...
	public static void main(String [] args)
	{
		...
		DocumentOpenUI obj=new DocumentOpenUI("불러 오기");
		obj.set();
	}
}