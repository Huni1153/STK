...
public class CalendarTime extends JPanel
{
   ...
   //private Object scheduleInfoUI;
   private JMyCalendar myCalendar;
   private String division;

   //public CalendarTime(){}
   public CalendarTime(AddScheduleInfoUI addScheduleInfoUI, JMyCalendar myCalendar, String division)
   {
      this.division = division;
      //this.addScheduleInfoUI = addScheduleInfoUI;
      //this.scheduleInfoUI = scheduleInfoUI;
   ...
   public CalendarTime(ModifyScheduleInfoUI modifyScheduleInfoUI, JMyCalendar myCalendar, String division)
   {
      this.division = division;
      //this.addScheduleInfoUI = addScheduleInfoUI;
      //this.scheduleInfoUI = scheduleInfoUI;
   ...
   class CalendarTimeActionListener implements ActionListener
   {
      ...
      public void actionPerformed(ActionEvent e)
      {
         ...
         {
            /*if(scheduleInfoUI instanceof AddScheduleInfoUI)
            {
               addScheduleInfoUI.getCalendarInfo(division, year, month, day, hourTxf.getText(), minTxf.getText());
            }
            else if(scheduleInfoUI instanceof ModifyScheduleInfoUI)
            {
               modifyScheduleInfoUI.getCalendarInfo(division, year, month, day, hourTxf.getText(), minTxf.getText());
            }*/
            if(addScheduleInfoUI != null)
               addScheduleInfoUI.getCalendarInfo(division, year, month, day, hourTxf.getText(), minTxf.getText());
            else if(modifyScheduleInfoUI != null)
               modifyScheduleInfoUI.getCalendarInfo(division, year, month, day, hourTxf.getText(), minTxf.getText());
