...
public class FileLoadUI extends JDialog
{
	...
	public FileLoadUI(String fileName)
	{
		...
		this.model=new DefaultTableModel(name,10);
	...
	public void set()
	{
		...
		this.bSave.addActionListener(new FileLoadUIListener());
	...
	class FileLoadUIListener implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if(e.getSource()==bSave)
			{
				if(row<0)
				{
					JOptionPane.showMessageDialog(null,"폴더를 선택하세요!", "오류", JOptionPane.ERROR_MESSAGE);
				}
				else
				{
					LoadUI load=new LoadUI();
					load.set();
				}
			}
