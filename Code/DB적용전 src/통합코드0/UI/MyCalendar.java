...
//	private Container contentPane;
	...
	public MyCalendar(){
		...
		Image prevImg=new ImageIcon("Icon/Left Arrow-50.png").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT);
		ImageIcon preIcon=new ImageIcon(prevImg);
		prevButton = new JButton(preIcon);
		Image nextImg=new ImageIcon("Icon/Right Arrow-50.png").getImage().getScaledInstance(30,30,Image.SCALE_DEFAULT);
