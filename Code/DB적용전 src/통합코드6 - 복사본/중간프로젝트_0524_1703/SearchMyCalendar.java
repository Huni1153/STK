...
public class SearchMyCalendar extends JDialog 
{
   ...
   public SearchMyCalendar(SchedulerUI schedulerUI, String division){
	...
	setLocation(400,50);
      setPreferredSize(new Dimension(330,380));
      ...
      TableColumnModelListener columnListener = new SearchMyCalendarSelectActionListener(tableCalendar, modelCalendar, yearCombo, monthLabel, schedulerUI, division, this);
